# Senior Business Analyst & Insights Portfolio
### Data Analytics | Process Automation | Operational Governance

Welcome to my professional portfolio repository. This project showcases my ability to translate high-volume operational data into actionable, executive-level insights. 

While these artifacts were developed within financial services and governance frameworks, the methodologies—Root Cause Analysis, Metric Tracking (AHT/CSAT/SLA), and Workflow Automation—are directly transferable to high-volume BPO and Contact Centre environments.
...
*Note: All data utilized across these artifacts has been heavily sanitized, anonymized, and aggregated to protect corporate and client data privacy.*
